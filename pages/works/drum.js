...
const Work = () => (
  <Layout title="DrumKit® Company">
    <Container>
      ...
      <WorkImage src="/images/works/drumkitcompany1.png" alt="DrumKit Company" />
      <WorkImage src="/images/works/drumkitcompany2.png" alt="DrumKit Company" />
      <WorkImage src="/images/works/drumkitcompany3.png" alt="DrumKit Company" />
    </Container>
  </Layout>
)

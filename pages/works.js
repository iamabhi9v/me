    ...
    <Container>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        <Section>
          ...
          >
            Moonlight consists of mostly sunlight reflected from the parts of
            the Moon&apos;s surface where the Sun&apos;s light strikes. A
            website with PARALLAX effect.
          </WorkGridItem>
        </Section>
        <Section>
          <WorkGridItem id="fda" title="Food Delivery App" thumbnail={thumbFda}>
            Food Delivery App based on React Native designed for iOS and
            Android.
          </WorkGridItem>
        </Section>
        ...
        <Section delay={0.1}>
          ...
          >
            &quot;Living The Social Life&quot; is a website based on HTML and
            CSS.
          </WorkGridItem>
        </Section>
        <Section delay={0.1}>
          <WorkGridItem
            id="gamezone"
            thumbnail={thumbGamezone}
            title="GameZone App"
          >
            An app based on Expo CLI, designed through React Native. Developed
            for iOS and Android.
          </WorkGridItem>
        </Section>
      </SimpleGrid>
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section delay={0.3}>
          <WorkGridItem
            id="grocerybudredux"
            thumbnail={thumbGrocerybudredux}
            title="Grocery Bud REDUX"
          >
      ...
      <SimpleGrid columns={[1, 1, 2]} gap={6}>
        ...
        <Section delay={0.5}>
          <WorkGridItem id="dice" thumbnail={thumbDice} title="DiceKit Company">
